...
- [Dive Into Python](https://diveintopython3.problemsolving.io/): much faster introduction to Python, a bit outdated but will get you ramped up really fast, especially if you've learned a number of programming language in the past.
...
- [Introduction to advanced Python](https://github.com/charlax/python-education/blob/master/advanced-python/README.md) (article).
...
- [bottle.py](https://github.com/bottlepy/bottle/blob/master/bottle.py): bottle is a web framework. It's a great resource because it's in all in whole file! Recommended reading. You can even print it.
...
[](https://github.com/charlax/python-education#code-practice-websites)
...
Reddit's [dailyprogrammer subreddit](https://www.reddit.com/r/dailyprogrammer) has some good exercises as well.
...
- Check [intro-to-python/exercises](https://github.com/charlax/python-education/blob/master/intro-to-python/exercises).
- Check [advanced-python/exercises](https://github.com/charlax/python-education/blob/master/advanced-python/exercises).
...
- General introduction: [Python debugging tools](http://blog.ionelmc.ro/2013/06/05/python-debugging-tools/)
...
I maintain a [list of antipatterns](https://github.com/charlax/python-education/blob/master/python-antipatterns.md) on this repo.
